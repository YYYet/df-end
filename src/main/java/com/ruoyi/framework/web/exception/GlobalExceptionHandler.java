...
import com.ruoyi.common.exception.TokenFailException;
...
//    }
     ...
     * 业务异常
     */
    @ExceptionHandler(TokenFailException.class)
    public AjaxResult handleTokenFailException(TokenFailException e, HttpServletRequest request)
    {
